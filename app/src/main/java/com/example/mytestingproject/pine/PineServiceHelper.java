...
import com.example.mytestingproject.MyApplication;
import com.example.mytestingproject.pine.request.TransactionRequest;
import com.example.mytestingproject.pine.response.BaseResponse;
...
public class PineServiceHelper {
    ...
    public void connect(PineCallBack pineCallBack , BasePineActivity basePineActivity) {
        ...
        if (!isBound) {
            ...
            MyApplication.mycontext.bindService(intent, this.connection, BIND_AUTO_CREATE);
    ...
    public void callPineService(TransactionRequest request) {
        ...
        Utils.INSTANCE.createLogcat("PRINT_Res","Request Body --> "+request);
        sendMessage(str);
    }
